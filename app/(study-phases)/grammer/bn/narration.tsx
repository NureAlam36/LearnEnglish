        ...
        !loading ? <ScrollView style={[styles.container, { backgroundColor: theme.bgPrimary }]} showsVerticalScrollIndicator={false}>
            <View style={{ padding: 15 }}>
                ...
                <View style={{ backgroundColor: '#d8efef', padding: 10, marginVertical: 20 }}>
                    <Text style={styles.noteText}>গঠন: Subject+ told/said+ Object+ that+ Subject(RS)+ Verb(RS)+ বাকী অংশ।</Text>
                </View>
                ...
                <View style={{ backgroundColor: '#d8efef', padding: 10, marginVertical: 20 }}>
                    <Text style={styles.noteText}>গঠন 01: Subject+ asked+ Object+ Wh-word+ Verb+ Subject(RS)+ Verb(RS)+ বাকী অংশ। [ Wh-word দ্বারা শুরু হলে।]</Text>
                </View>
                ...
                <View style={{ backgroundColor: '#d8efef', padding: 10, marginVertical: 20 }}>
                    <Text style={styles.noteText}>গঠন 02: Subject+ asked+ Object+ if+ Subject(RS)+ Verb(RS)+ বাকী অংশ। [ Auxiliary Verb  দ্বারা শুরু হলে]</Text>
                </View>
                ...
                <View style={{ backgroundColor: '#d8efef', padding: 10, marginVertical: 20 }}>
                    <Text style={styles.noteText}>গঠন 01: Subject + ordered(আদেশ)/ advised(উপদেশ)/ forbade(নিষেধ)/ requested (অনুরোধ)+ Object+ to/not to+ Verb(RS)+ বাকী অংশ। [Main Verb দ্বারা শুরু হলে।]</Text>
                </View>
                ...
                <View style={{ backgroundColor: '#d8efef', padding: 10, marginVertical: 15 }}>
                    <Text style={styles.noteText}>গঠন 02: Subject+ proposed/suggested + Object + that+ Subject(RS) + should + Verb(RS)+ বাকি অংশ। [Let দ্বারা শুরু হলে।]</Text>
                </View>
                ...
                <View style={{ backgroundColor: '#d8efef', padding: 10, marginVertical: 15 }}>
                    <Text style={styles.noteText}>গঠন: Subject + wished/prayed + that + Subject(RS) + may/might + Verb (RS) + বাকি অংশ।</Text>
                </View>
                ...
                <View style={{ backgroundColor: '#d8efef', padding: 10, marginVertical: 20 }}>
                    <Text style={styles.noteText}>গঠন: Subject + exclaimed with joy/exclaimed with sorrow + that + Subject(RS) + Verb(RS) + very/great( যদি How বা What দ্বারা শুরু হয়) + বাকী অংশ।</Text>
                </View>
                ...
                <View style={{ backgroundColor: '#d8efef', padding: 10, marginVertical: 20 }}>
                    <Text style={styles.noteText}>গঠন: Subject+ thanked+ Object.</Text>
                </View>
                ...
                <View style={{ backgroundColor: '#d8efef', padding: 10, marginVertical: 20 }}>
                    <Text style={styles.noteText}>গঠন: Subject+ bade+ Object+ good-bye.</Text>
                </View>
                ...
                <View style={{ backgroundColor: '#d8efef', padding: 10, marginVertical: 20 }}>
                    <Text style={styles.noteText}>গঠন: Subject+ wished+ Object+ good morning/evening/night ইত্যাদি।</Text>
                </View>
                ...
                <View style={{ backgroundColor: '#d8efef', padding: 10, marginVertical: 20 }}>
                    <Text style={styles.noteText}>গঠন: Addressing me/him/her/them as+ সম্বোধন সূচক শব্দ+ Sentence অনুয়াযী গঠন।</Text>
                </View>
                ...
                <View style={{ backgroundColor: '#d8efef', padding: 10, marginTop: 20 }}>
                    <Text style={styles.noteText}>Note: কথার প্রেক্ষাপটে মাঝে মধ্যে then এবং প্রশ্নের উত্তরে said that এর জায়গায় replied that ব্যবহার করতে হবে।</Text>
                </View>
            </View>
        </ScrollView>
            : <PreLoader />
