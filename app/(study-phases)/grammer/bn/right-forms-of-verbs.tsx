        ...
        !loading ? <ScrollView style={[styles.container, { backgroundColor: theme.bgPrimary }]} showsVerticalScrollIndicator={false}>
            <View style={{ padding: 15 }}>
                ...
                <View style={{ backgroundColor: '#d8efef', padding: 10 }}>
                    <Text style={styles.noteText}>Present Indefinite Tense এর subject যদি plural number হয় তাহলে verb এর শেষে s/es যোগ হবে না।</Text>
                </View>
                ...
                <View style={{ backgroundColor: '#d8efef', padding: 10, marginTop: 15, marginBottom: 15 }}>
                    <Text style={styles.noteText}>যদি had/if যুক্ত clause টি past perfect tense হয় তাহলে পরের clause টি তে subject এর পর would have/could have/might have বসে এবং verb এর past participle form হয়।</Text>
                </View>
