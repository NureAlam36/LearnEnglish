        ...
        !loading ? <ScrollView style={[styles.container, { backgroundColor: theme.bgPrimary }]} showsVerticalScrollIndicator={false}>
            <View style={{ padding: 15 }}>
                ...
                <View style={{ backgroundColor: '#d8efef', padding: 10, marginTop: 20 }}>
                    <Text style={styles.noteText}>Note: প্রত্যেক Sentence এর Affirmative (হ্যাঁ বোধক) বা Negative (না বোধক) দিক আছে।</Text>
                </View>
                ...
                <View style={{ backgroundColor: '#d8efef', padding: 10, marginTop: 20, marginBottom: 15 }}>
                    <Text style={styles.noteText}>Note: Interrogative Sentence এ দুই ধরনের Auxiliary verb ব্যবহার করা হয় </Text>
                </View>
                ...
                <View style={{ backgroundColor: '#d8efef', padding: 10, marginTop: 20 }}>
                    <Text style={styles.noteText}>Note: Imperative sentence চেনার উপায় হল বাক্যে শুরুতে verb থাকবে বা বাক্যটি আদেশ, উপদেশ, অনুরোধ, দ্বারা শুরু হবে। বাক্যের সর্বদা “you” উহ্য থাকে</Text>
                </View>
                ...
                <View style={{ backgroundColor: '#d8efef', padding: 10, marginTop: 20 }}>
                    <Text style={styles.noteText}>Note: বাক্যের শুরুতে” May/ I wish  ব্যবহৃত হয়ে sentence তৈরি হবে</Text>
                </View>
                ...
                <View style={{ backgroundColor: '#d8efef', padding: 10, marginTop: 20 }}>
                    <Text style={styles.noteText}>Note: বাক্যের শুরুতে what/Alas/ Bravo/Hurrah দিয়ে শুরু হবে এবং শেষে !(বিস্ময় সূচক চিহ্ন) ব্যবহৃত হবে।</Text>
                </View>
                ...
                <View style={{ backgroundColor: '#d8efef', padding: 10, marginTop: 20 }}>
                    <Text style={styles.noteText}>Note: প্রত্যেকটি বাক্যে একটি করে Finite verb থাকবে।</Text>
                </View>
                ...
                <View style={{ backgroundColor: '#d8efef', padding: 10, marginTop: 20 }}>
                    <Text style={styles.noteText}>Note: দুইটি clause মিলে complex sentence তৈরি হয়</Text>
                </View>
                ...
                <View style={{ backgroundColor: '#d8efef', padding: 10, marginTop: 20 }}>
                    <Text style={styles.noteText}>Note: compound sentence সর্বদা coordinating conjunction থাকবেই।</Text>
                </View>
            </View>
        </ScrollView>
            : <PreLoader />
