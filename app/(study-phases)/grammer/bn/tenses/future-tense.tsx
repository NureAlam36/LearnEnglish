        ...
        !loading ? <ScrollView style={styles.container}>
            <View style={{ padding: 15 }}>
                ...
                <View style={{ backgroundColor: '#d8efef', padding: 10, marginTop: 20 }}>
                    <Text style={styles.noteText}>Note: 1st person  তথা I ও We এর পর shall বসে। এছাড়া অন্য সব ক্ষেত্রে will বসবে।কোন কাজ যদি জোড় দিয়ে করা বুঝায় বা বক্তার ইচ্ছে, আদেশ, উপদেশ, দৃঢ় সংকল্প বুঝায় তাহলে I ও We এর পর will। এছাড়া অন্য সব ক্ষেত্রে shall বসবে।</Text>

                    <Text style={[styles.heading_md, { marginTop: 20, marginBottom: 5, color: '#a72a24', fontStyle: 'italic' }]}>উদাহরণ:</Text>
                    <View style={{ display: 'flex', gap: 5 }}>
                        <Text style={styles.noteText}>- সে বিদ্যালয়ে যাবেই (জোড় দেয়া বুঝায়)- He shall go to the school.</Text>
                        <Text style={styles.noteText}>- আমি কাজটি করিবই(জোড় দেয়া বুঝায়)- I will do the work. Or I must do the work.</Text>
                        <Text style={styles.noteText}>- আমি আর একবার ভাগ্য পরীক্ষা করব (ইচ্ছা বুঝায়)-I will try my luck again.</Text>
                        <Text style={styles.noteText}>- তোমরা মহত ব্যক্তিদের পদাংক অনুসরন করবে(উপদেশ)-You shall follow the footsteps of great men.</Text>
                    </View>
                </View>

                <View style={{ backgroundColor: '#d8efef', padding: 10, marginTop: 20 }}>
                    <Text style={styles.noteText}>Note: কোন কাজ যদি Near Future বুঝায় তাহলে বাক্যটি Future indefinite tense এর নিয়মানুসারে করা যাবে আবার Present Continuos Tense এর নিয়মানুসারেও করা যাবে।</Text>

                    <Text style={[styles.heading_md, { marginTop: 20, marginBottom: 5, color: '#a72a24', fontStyle: 'italic' }]}>উদাহরণ:</Text>
                    <View style={{ display: 'flex', gap: 5 }}>
                        <Text style={styles.noteText}>- আমি আগামীকাল বাড়ী যাব- I shall go home tomorrow. বা I am going to home tomorrow.</Text>
                    </View>
                </View>
                ...
                <View style={{ backgroundColor: '#d8efef', padding: 10, marginTop: 20 }}>
                    <Text style={styles.noteText}>Note: এখানে মনে রাখদত হবে before এর আগে after এর পরে Future Perfect Tense হবে । অন্যটি simple present tense এর হবে।</Text>
                </View>
                ...
                <View style={{ backgroundColor: '#d8efef', padding: 10, marginTop: 20 }}>
                    <Text style={styles.noteText}>Note: Subject-এর পর shall have been বা will have been বসে এবং মূল verb-এর শেষে ing যোগ হয়।দুইটি বাক্য থাকলে Befor/When বা After/That থাকবে।</Text>
                </View>
                ...
                <View style={{ backgroundColor: '#d8efef', padding: 10, marginTop: 20 }}>
                    <Text style={styles.noteText}>Note:  ভবিষ্যৎ কালে দুটি কাজের মধ্যে যে কাজটি আগে চলতে থাকবে তা future perfect tense হয় যে কাজটি পরে হবে তা simple present tense হবে, তবে বাক্যের ধরন অনুযায়ী Simple Present Tense এর পরিবর্ত Future Indefinite Tense হবে।</Text>

                    <Text style={[styles.heading_md, { marginTop: 20, marginBottom: 5, color: '#a72a24', fontStyle: 'italic' }]}>উদাহরণ:</Text>
                    <View style={{ display: 'flex', gap: 5 }}>
                        <Text style={styles.noteText}>- এক ঘন্টা কাজ করতে থাকার পর তারা বিশ্রাম করবে- They will take rest when they will have been working for an hour.</Text>
                    </View>
                </View>
            </View>
        </ScrollView>
