        ...
        !loading ? <ScrollView style={[styles.container, { backgroundColor: theme.bgPrimary }]} showsVerticalScrollIndicator={false}>
            <View style={{ padding: 15 }}>
                ...
                <View style={{ backgroundColor: '#d8efef', padding: 10, marginBottom: 30, }}>
                    <Text style={styles.noteText}>Consonant সমূহঃ B, C, D, F, G, H, J, K, L, M, N, P, Q, R, S, T, V, W, X, Y, Z. অর্থাৎ (A, E, I, O, U) ব্যাতীত বাকি সবগুলোই Consonant.</Text>
                </View>
                ...
                <View style={{ backgroundColor: '#d8efef', padding: 10, marginBottom: 30, }}>
                    <Text style={styles.noteText}>Vowel সমূহঃ A, E, I, O, U. অর্থাৎ ইংরেজি alphabet =A, E, I, O, U কে Vowel বলা হয়।</Text>
                </View>
