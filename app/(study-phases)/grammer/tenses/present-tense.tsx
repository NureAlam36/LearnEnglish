...
const PresentTense = () => {
    ...
    return (
        <React.Fragment>
            <Stack.Screen
                options={{
                    headerTitle: () => <Text style={{ fontSize: 18, color: 'white', fontFamily: FONT.medium, }}>Present Tense</Text>,
            ...
            />
            {
                !loading ? <ScrollView style={styles.container}>
                    ...
                    <View style={{ backgroundColor: '#d8efef', padding: 10, marginTop: 20 }}>
                        <Text style={styles.text}>Note: Near future বা নিকটতম ভবিষ্যত বাক্যটিতে তেছি/তেছ নাই। এই বাক্যটি Future Indefinite Tense এর। তবে এ জাতীয় বাক্য উপরোক্ত দুইভাবে করা যায়।</Text>
                    </View>
