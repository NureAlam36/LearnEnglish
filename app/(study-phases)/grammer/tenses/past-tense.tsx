        ...
        <React.Fragment>
            ...
            />
            {
                !loading ? <ScrollView style={styles.container}>
                    ...
                    <View style={{ backgroundColor: '#d8efef', padding: 10, marginTop: 20 }}>
                        <Text style={styles.text}>Note: Past indefinite Tense যুক্ত কোন sentence এ যদি main verb না থাকে তাহলে সেখানে be verb (Am,Is,Are,Was,Were) ই main verb হিসেবে ব্যবহৃত হবে।</Text>

                        <Text style={[styles.heading_md, { marginTop: 20, marginBottom: 5, color: '#a72a24', fontStyle: 'italic' }]}>উদাহরণ:</Text>
                        <View style={{ display: 'flex', gap: 5 }}>
                            <Text style={styles.text}>- I was ill.</Text>
                            <Text style={styles.text}>- He was good.</Text>
                        </View>
                    </View>

                    <View style={{ backgroundColor: '#d8efef', padding: 10, marginTop: 20 }}>
                        <Text style={styles.text}>Note: কিছু কিছু বাক্য আছে যা দেখতে Present Perfect Tense এর মতো কিন্তু ইংরেজিতে অনুবাদ করতে হচ্ছে Past Indefinite Tense এর নিয়মানুসারে।এটা তখনই হবে যখন সুনির্দিষ্ট করে কোন সাল বা তারিখ বা দিন উল্লেখ থাকবে যা অতীত হয়ে গেছে।</Text>

                        <Text style={[styles.heading_md, { marginTop: 20, marginBottom: 5, color: '#a72a24', fontStyle: 'italic' }]}>উদাহরণ:</Text>
                        <View style={{ display: 'flex', gap: 5 }}>
                            <Text style={styles.text}>- সে ১৯৭১ সালে এসএসসি পাশ করিয়াছে- He has passed the SSC in 1971. না হয়ে হবে He passed the SSC in 1971.</Text>
                            <Text style={styles.text}>- সে গতকাল বাড়ি আসিয়াছে- He has come home yesterday. না হয়ে হবে  He came home yesterday.</Text>
                        </View>
                    ...
                    <View style={{ backgroundColor: '#d8efef', padding: 10, marginTop: 20 }}>
                        <Text style={styles.text}>Note: subject first person and third person singular number হলে was বসবে। we, you, they এবং অন্যান্য plural number এর শেষে were বসবে। অর্থাৎ I এর পরে was এবং you এর পরে were ব্যতীত subject এক বচন হলে was এবং subject বহু বচন হলে were বসবে।</Text>
                    </View>
