            ...
            >
                ...
                <View style={{ display: 'flex', flexDirection: 'row', gap: 20, alignItems: 'center', paddingHorizontal: 20, marginTop: 20, paddingBottom: 55 }}>
                    <View>
                        ...
                        >
                            <Image style={{ width: 65, height: 65, borderRadius: 50 }} source={{ uri: 'https://image.lexica.art/full_jpg/19f280a2-2b97-4be2-b782-1fd5c70b84f4' }} />
                        </LinearGradient>
                    </View>
                    <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', flex: 1 }}>
                        <View style={{ display: 'flex', }}>
                            ...
                            <Text style={{ fontFamily: FONT.regular, color: 'white' }}>ID: {userData?.id}</Text>
                        </View>
            ...
            <View style={{ backgroundColor: theme.bgSecondary, display: 'flex', flexDirection: 'row', height: 100, position: 'absolute', top: 10, marginTop: -50, margin: 20, padding: 10, borderRadius: 20, borderWidth: 1, borderColor: colorScheme === 'light' ? '#ebebeb' : theme.borderColor, }}>
                <View style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', width: '100%' }}>
                    <View style={{ display: 'flex', alignItems: 'center', gap: 5, flex: 1, borderRightWidth: 1, borderRightColor: theme.borderColor }}>
                        ...
                        <Text style={{ fontFamily: FONT.medium, fontSize: 17, color: theme.textPrimary }}>10</Text>
                    </View>
                    <View style={{ display: 'flex', alignItems: 'center', gap: 5, flex: 1, borderRightWidth: 1, borderRightColor: theme.borderColor }}>
                        <Text style={{ color: theme.textPrimary, fontFamily: FONT.medium }}>Passed</Text>
                        <Text style={{ fontFamily: FONT.medium, fontSize: 17, color: '#00c47d' }}>10</Text>
                    </View>
                    <View style={{ display: 'flex', alignItems: 'center', gap: 5, flex: 1, }}>
                        <Text style={{ color: theme.textPrimary, fontFamily: FONT.medium }}>Failed</Text>
        ...
        <ScrollView>
            <View style={{ paddingHorizontal: 15, paddingVertical: 10, }}>
                ...
                <View style={{ backgroundColor: colorScheme === 'light' ? '#f9f9f9' : COLORS.darkSecondary, display: 'flex', gap: 10, padding: 10, borderRadius: 10, borderWidth: 1, borderColor: colorScheme === 'light' ? '#ebebeb' : theme.borderColor }}>
                    <View style={{ display: 'flex', }}>
                        ...
                        <Text style={{ fontFamily: FONT.medium, fontSize: 16, color: theme.textSecondary, opacity: 0.9 }}>{userData?.email}</Text>
                    </View>
                    {
                        userData?.mobile && <View style={{ display: 'flex', }}>
                            <Text style={{ color: COLORS.primary, fontFamily: FONT.regular, opacity: 0.7 }}>Mobile</Text>
                            <Text style={{ fontFamily: FONT.medium, fontSize: 16, color: theme.textSecondary, opacity: 0.9 }}>{userData?.mobile}</Text>
                        </View>
                    }
                    {
                        userData?.dob && <View style={{ display: 'flex', }}>
                            <Text style={{ color: COLORS.primary, fontFamily: FONT.regular, opacity: 0.7 }}>Date of birth</Text>
                            <Text style={{ fontFamily: FONT.medium, fontSize: 16, color: theme.textSecondary, opacity: 0.9 }}>{userData?.dob}</Text>
                        </View>
                    }
                    <View style={{ display: 'flex', }}>
            ...
            <View style={{ paddingHorizontal: 15, paddingVertical: 10 }}>
                ...
                <View style={[styles.sectionWrap, { borderWidth: 1, borderColor: colorScheme === 'light' ? '#ebebeb' : theme.borderColor, borderRadius: 10 }]}>
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate('change_password_screen')} activeOpacity={0.7} style={styles.item}>
                        <View style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', gap: 15 }}>
